            ...
            while (!stop) {
                ...
                switch (command) {
                    ...
                    case "File_replicate":
                        ...
                        Thread receiveReplicationFileTread = new ReceiveReplicateFileThread(socket.getRemoteSocketAddress(), client.getReplicaDir(), client.getLocalFileSet(), client.getPrevNode());
